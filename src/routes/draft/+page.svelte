...
>
  <div class="absolute w-full h-full top-0 left-0 pointer-events-none z-[-1]">
    <img
      ...
      alt="Flower 1"
      class="absolute -bottom-24 -right-12 w-1/3 rotate-y-180 opacity-35 right-core"
    />

    <img
      src="/assets/flowers/flower-2.png"
      alt="Flower 2"
      class="absolute -top-24 -left-24 w-1/4 opacity-35 rotate-135 left-core"
    />

    <img
      src="/assets/dove.png"
      alt="Dove"
      class="absolute -bottom-24 -left-24 w-1/4 opacity-35 -rotate-25 right-core"
    ...
    <img
      ...
      alt="Flower 3"
      class="absolute -top-48 -right-12 w-1/5 opacity-35 rotate-200 left-core"
    />
